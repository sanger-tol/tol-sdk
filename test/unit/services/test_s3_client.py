...
def test_get_object_calls_fget_object(mock_minio):
    ...
    mock_instance.fget_object.assert_called_once_with(bucket_name='bucket',
                                                      object_name='obj', file_path='/tmp/file')
...
def test_put_object_calls_fput_object(mock_minio):
    ...
    mock_instance.fput_object.assert_called_once_with(bucket_name='bucket',
                                                      object_name='obj', file_path='/tmp/file')
