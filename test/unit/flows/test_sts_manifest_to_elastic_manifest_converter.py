...
class TestStsManifestToElasticManifestConverter(TestCase):
    def test_convert(self):
        ...
        self.assertEqual(ret1.attributes, {
            'sts_project': 'test_project',
            'sts_programme': 'test_programme',
            'sts_status': 'COMPLETE',
            'sts_copo_profile_title': 'COPO1',
            'sts_submit_date': datetime.datetime(2024, 4, 4),
            'sts_update_date': datetime.datetime(2024, 5, 5),
            'sts_accept_date': datetime.datetime(2024, 6, 6),
            'sts_receive_date': datetime.datetime(2024, 6, 7),
            'sts_reject_date': datetime.datetime(2024, 7, 7),
            'sts_archive_date': datetime.datetime(2024, 8, 8),
            'sts_status_updated_at': datetime.datetime(2024, 9, 9),
            'sts_shipment_status_updated_at': datetime.datetime(2024, 10, 10),
            'sts_research_governance_status': 'PASSED',
            'sts_rg_status_updated_at': datetime.datetime(2024, 11, 11),
            'sts_wildlife_and_env_status': 'PASSED',
            'sts_wildlife_status_updated_at': datetime.datetime(2024, 12, 12),
