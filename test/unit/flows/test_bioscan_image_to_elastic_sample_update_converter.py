...
class TestBioscanImageToElasticSampleUpdateConverter(TestCase):
    def test_convert(self):
        ...
        expected1 = (None, {
            'specimen.id': 'sample_one',
            'image_url': 'https://BUCKET_NAME_ONE.cog.sanger.ac.uk/sample_one.jpeg',
            'image_modified': datetime(2020, 1, 1),
        })
        expected2 = (None, {
            'specimen.id': 'sample_two',
            'image_url': 'https://BUCKET_NAME_TWO.cog.sanger.ac.uk/prefix/sample_two.png',
            'image_modified': datetime(2023, 5, 7),
        })
