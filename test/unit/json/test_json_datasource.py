...
def mock_json_data_source() -> JsonDataSource:
    jds = MockJsonDataSource({
        'uri': '',  # Not used in mock
        'type': 'object1',
        'id_attribute': 'Id',
        'mappings': {
            'id': {
    ...
    core_data_object_mock = core_data_object(jds)
    return core_data_object_mock, jds
