        ...
        if s3_object == 'data/assembly.json':
            return [{
                ...
                'lustre_path_analysis_base': (
                    ...
                    'analysis/ASM270686v2'
                ),
                'lustre_path_assembly': (
                    '/lustre/scratch123/tol/projects/lepidoptera/data/insects/Spodoptera_litura/'
                    'assembly/release/ASM270686v2/insdc'
                ),
                'lustre_path_species': (
                    '/lustre/scratch123/tol/projects/lepidoptera/data/insects/Spodoptera_litura'
                )
        ...
        if s3_object == 'GCA_002706865.2/data/analysis.json':
            ...
            { # noqa
                ...
                'description': (
                    ...
                    "<a href='https://blobtoolkit.genomehubs.org/blobtools2/'>BlobTools2</a> t"
                    'o aid in the identification and filtering of contaminants and other cobionts'
                    ' as part of the assembly QC process.'
                ),
                's3': (
                    'https://blobtoolkit.genomehubs.org/view/dataset/'
                    'GCA_002706865.1/dataset/MTZO01.1/blob#Filters'
                ),
...
def gap_data_source() -> GapDataSource:
    gds = MockGapDataSource({
        ...
        'mappings': {
            ...
            'lustre_path_analysis_base': {'heading': 'lustre_path_analysis_base', 'type': 'str'},
            'lustre_path_assembly': {'heading': 'lustre_path_assembly', 'type': 'str'},
            'lustre_path_species': {'heading': 'lustre_path_species', 'type': 'str'}
        }
    })
    ...
    def test_get_to_many_relations(self):
        ...
        self.assertEqual({
            ...
            'description': (
                ...
                "<a href='https://blobtoolkit.genomehubs.org/specification/'>BlobDir</a> "
                'datasets produced by '
                "<a href='https://blobtoolkit.genomehubs.org/blobtools2/'>BlobTools2</a> "
                'to aid in the identification and filtering of contaminants '
                'and other cobionts as part of the assembly QC process.'
            ),
            's3': (
                'https://blobtoolkit.genomehubs.org/view/dataset/GCA_002706865.1/dataset/'
                'MTZO01.1/blob#Filters'
            ),
            'lustre_path_analysis': None
        }, obj2.attributes)
