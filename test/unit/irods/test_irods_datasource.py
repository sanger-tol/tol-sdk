...
class TestIrodsDataSource(TestCase):
    ...
    def test_get_list(self):
        ...
        first = next(returned)
        self.assertEqual({'run_id': '1', 'position': '1', 'tag': '1', 'data_name': 'test.bam'},
                         first.attributes)
        second = next(returned)
        self.assertEqual({'run_id': '1', 'position': '2', 'tag': '1', 'data_name': 'test2.bam'},
                         second.attributes)
        third = next(returned)
        self.assertEqual({'run_id': '2', 'position': '1', 'tag': '2', 'data_name': 'test3.bam'},
                         third.attributes)
