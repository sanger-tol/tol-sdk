...
class TestIrodsDataSource(TestCase):
    ...
    def test_get_file_data(self):
        ...
        results = list(ids.get_file_data(['1234']))
        expected = [{'id': 1, 'field1': 'value1', 'field2': 'value2'},
                    {'id': 2, 'field1': 'value3', 'field2': 'value4'}]
    ...
    def test_get_run_data(self):
        ...
        mocked_function = ids.irods.query.return_value.add_keyword.return_value \
            .filter.return_value.filter.return_value.get_results
        mocked_function.return_value = [
            {'run_id': '1', 'position': '1', 'tag_index': '1'},
            {'run_id': '1', 'position': '1', 'tag_index': '1'},
            {'run_id': '2', 'position': '2', 'tag_index': '2'}
        ]

        results = list(ids.get_run_data(['1234']))
        expected = [{'run_id': '1', 'position': '1', 'tag_index': '1', 'file_exists': True},
                    {'run_id': '2', 'position': '2', 'tag_index': '2', 'file_exists': True}]
        self.assertEqual(expected, results)
