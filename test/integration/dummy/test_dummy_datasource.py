...
class TestDummyDataSource(TestCase):
    ...
    def test_get_one_record(self):
        ...
        assert obj.category.id == 'cat2'
        assert obj.category.type == 'category'
        assert obj.sub_category is not None
        assert obj.sub_category.id == 'cat1'
        assert obj.sub_category.type == 'category'
