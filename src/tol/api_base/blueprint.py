...
def _core_blueprint(
    ...
    and specialized operations like cursor-based pagination.

    Args:
        data_source_dict (dict[str, DataSource]): Dictionary mapping object types to DataSource instances.
        url_prefix (str): URL prefix for all data endpoints.
        auth_inspector (Optional[AuthInspector], optional): Authentication inspector for request authorization.
    ...
    *data_sources: DataSource,
    ...
    Args:
        *data_sources (DataSource): Variable number of DataSource instances to expose.
        ...
        config_prefix (str, optional): URL prefix for configuration endpoints. Defaults to '/_config'.
        auth_inspector (Optional[AuthInspector], optional): Authentication inspector. Defaults to None.
