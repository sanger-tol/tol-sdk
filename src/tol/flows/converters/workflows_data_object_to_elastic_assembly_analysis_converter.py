...
class WorkflowsDataObjectToElasticAssemblyAnalysisConverter(
    ...
    def convert(self, data_object: DataObject) -> Iterable[DataObject]:
        analysis_id = self.analysis_id(data_object)
        if analysis_id:
            attributes = {
                'workflow_name': data_object.output_workflow_run.workflow.name,
                'workflow_version': data_object.output_workflow_run.workflow.version,
                'workflow_description': data_object.output_workflow_run.workflow.description,
                'start_date': data_object.output_workflow_run.started_at,
                'end_date': data_object.output_workflow_run.ended_at
            }
